...
. Review the next dialog window and press *Create VirtualMachine*
+
...
+
[NOTE]
It is not needed for this workshop to perform the installation. Feel free to start the installation and continue to the next steps.
+
[IMPORTANT]
...
You may continue to the next lab, _Virtual Machine Cusotmization Lab_, where you will customize the VM during creation and you will manage the VM.