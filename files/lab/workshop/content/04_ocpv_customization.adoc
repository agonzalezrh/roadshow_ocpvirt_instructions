...
. Scroll down and check the parameters for the temaplte
+
...
. Navigate to tab *Configuration* and subtab *Disks*. Revie wthe VM was created with a container disk as the template defined
+
